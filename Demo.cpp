...
void Demo::Init() {
	...
	shaderProgram2 = BuildShader("vertexShader2.vert", "fragmentShader2.frag", nullptr);
...
void Demo::BuildColoredCube() {
	...
	int width, height;
	unsigned char* image = SOIL_load_image("poster.jpg", &width, &height, 0, SOIL_LOAD_RGBA);
...
{
	UseShader(shaderProgram2);

	glActiveTexture(GL_TEXTURE0);
	glBindTexture(GL_TEXTURE_2D, texture2);
	glUniform1i(glGetUniformLocation(this->shaderProgram2, "ourTexture"), 0);
